...
from customization_support import get_KITTIMOTS_dicts2
...
for d in ['train', 'valid']:
    DatasetCatalog.register("KITTIMOTS_" + d, lambda d=d: get_KITTIMOTS_dicts2(d))
...
saving_enabled = True
saved_KITTIMOTS_dicts = './KITTIMOTS_dicts_2_class.pkl'
...
if os.path.exists(saved_KITTIMOTS_dicts):
    ...
    dataset_dicts = get_KITTIMOTS_dicts2('train')
...
image = Image.fromarray(out.get_image()[:, :, ::-1])
image.save('detectron2_trained_2classes.png',)
...
evaluator = COCOEvaluator("KITTIMOTS_valid", output_dir="./output_2cls")
